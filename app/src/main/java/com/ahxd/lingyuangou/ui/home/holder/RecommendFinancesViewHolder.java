...
public class RecommendFinancesViewHolder extends HomeBaseViewHolder<HomeFoodShopBean> {
    ...
    public RecommendFinancesViewHolder(View itemView) {
        super(itemView);
    ...
    public void setData(List<HomeFoodShopBean> mFoodsData, int position) {
        label.setText("推荐金融");
        label.setBackgroundResource(R.mipmap.icon_cat_09);
        if (position == 0) {
