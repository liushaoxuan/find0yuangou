...
public class RecommendHealthViewHolder extends HomeBaseViewHolder<HomeFoodShopBean> {
    ...
    public RecommendHealthViewHolder(View itemView) {
        super(itemView);
    ...
    public void setData(List<HomeFoodShopBean> mFoodsData, int position) {
        label.setText("推荐健康");
        label.setBackgroundResource(R.mipmap.icon_cat_06);
        if (position == 0) {
