...
import com.ahxd.lingyuangou.ui.home.presenter.GiftGoodDetailPresenter;
...
/**
 * Created by Mao Zhendong on 2018/1/23.
 */

public class GiftGoodDetailActivity extends BaseActivity implements IGiftGoodDetailContract.IGiftGoodDetailView {
    ...
    private GiftGoodDetailPresenter mPresenter;
...
//                LoadingView.stopLoading();
    ...
    protected void initData() {
        ...
        wvGoodDetailWebview.loadUrl(HostUrl.URL_GIFTGOOD_DETAIL + "?goodsId=" + mGoodsId
                + "&token=" + (String) SPUtils.get(this, Constant.KEY_TOKEN, ""));

        mPresenter = new GiftGoodDetailPresenter(this);
    }
    ...
    class GoodsDetailInterface {
        ...
        public void androidGoods(String msg) {
            ...
            try {
                ...
                switch (data.optString("flag")) {
                    case "gwc":
                        Intent gwcIntent = new Intent(GiftGoodDetailActivity.this, MainActivity.class);
                        gwcIntent.putExtra("type", "giftcart");
                    ...
                    case "ads":
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                AdsPopupWindow popupWindow = new AdsPopupWindow(GiftGoodDetailActivity.this);
                                popupWindow.show(data.optString("incomeRate"));
                            }
                        });
                        break;
                    case "pj":
                        Intent pjIntent = new Intent(GiftGoodDetailActivity.this, FoodShopEvaluateListActivity.class);
        ...
        public void cart(String msg) {
            ...
            try {
                ...
                mPresenter.addGiftGoodCart(data.optString("good_id"), data.optString("goodsSpecId"),
        ...
        public void gobuy(String msg) {
            ...
            try {
                JSONObject data = new JSONObject(msg);
                mPresenter.buyGiftGoodNow(data.optString("goodsId"),
        ...
        @JavascriptInterface
        public void login() {
            Intent intent = new Intent(GiftGoodDetailActivity.this, LoginActivity.class);
