...
public class RecommendEduViewHolder extends HomeBaseViewHolder<HomeFoodShopBean> {
    ...
    public RecommendEduViewHolder(View itemView) {
        super(itemView);
    ...
    public void setData(List<HomeFoodShopBean> mFoodsData, int position) {
        label.setText("推荐教育");
        label.setBackgroundResource(R.mipmap.icon_cat_04);
        if (position == 0) {
