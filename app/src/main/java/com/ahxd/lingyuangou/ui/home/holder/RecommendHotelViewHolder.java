...
public class RecommendHotelViewHolder extends HomeBaseViewHolder<HomeFoodShopBean> {
    ...
    public RecommendHotelViewHolder(View itemView) {
        super(itemView);
    ...
    public void setData(List<HomeFoodShopBean> mFoodsData, int position) {
        label.setText("推荐酒店");
        label.setBackgroundResource(R.drawable.icon_cat_recomand_hotal);
        if (position == 0) {
