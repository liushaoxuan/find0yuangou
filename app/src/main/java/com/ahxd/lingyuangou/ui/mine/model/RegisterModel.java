...
public class RegisterModel implements IRegisterContract.IRegisterModel {
    ...
    public void register(String invite, String loginName, String loginPwd, String reloginPwd,
                         String yzm, final IRegisterCallback callback) {

        OkGo.<String>post(HostUrl.URL_REGISTER)
                ...
                .execute(new MaoStringCallback(callback) {
                    ...
                    protected void onSuccess(JSONObject root) {
                        callback.onRegister(root.optString(Constant.RESP_MSG));
                    }
                });
    ...
    @Override
    public void getValidateCode(String tel, final IRegisterCallback callback) {
        OkGo.<String>post(HostUrl.URL_GET_VALIDATE_CODE)
                .params("tel", tel)
                .execute(new MaoStringCallback(callback) {
                    @Override
                    protected void onSuccess(JSONObject root) {
