...
public class RecommendFoodsViewHolder extends HomeBaseViewHolder<HomeFoodShopBean> {
    ...
    public RecommendFoodsViewHolder(View itemView) {
        super(itemView);
    ...
    public void setData(List<HomeFoodShopBean> mFoodsData, int position) {
        label.setText("推荐美食");
        label.setBackgroundResource(R.drawable.icon_cat_recomand_foods);
        if (position == 0) {
