...
public class RecommendCommerceViewHolder extends HomeBaseViewHolder<HomeFoodShopBean> {
    ...
    public RecommendCommerceViewHolder(View itemView) {
        super(itemView);
    ...
    public void setData(List<HomeFoodShopBean> mFoodsData, int position) {
        label.setText("推荐商务");
        label.setBackgroundResource(R.drawable.icon_cat_recomand_shangwu);
        if (position == 0) {
