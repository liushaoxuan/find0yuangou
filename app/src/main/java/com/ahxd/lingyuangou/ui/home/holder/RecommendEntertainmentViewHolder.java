...
public class RecommendEntertainmentViewHolder extends HomeBaseViewHolder<HomeFoodShopBean> {
    ...
    public RecommendEntertainmentViewHolder(View itemView) {
        super(itemView);
    ...
    public void setData(List<HomeFoodShopBean> mFoodsData, int position) {
        label.setText("推荐娱乐");
        label.setBackgroundResource(R.mipmap.icon_cat_05);
        if (position == 0) {
