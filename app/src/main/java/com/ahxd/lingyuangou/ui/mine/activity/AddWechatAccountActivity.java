...
public class AddWechatAccountActivity extends BaseActivity implements IAlipayWechatContract.IAlipayWechatView{
    ...
    protected void initView() {
        super.initView();
        setToolBarTitle("添加微信支付");
        tvAccountName.setText("微信支付账号");
        etAccount.setHint("输入微信支付账号");
    }
