...
public class RecommendHouseHoldViewHolder extends HomeBaseViewHolder<HomeFoodShopBean> {
    ...
    public RecommendHouseHoldViewHolder(View itemView) {
        super(itemView);
    ...
    public void setData(List<HomeFoodShopBean> mFoodsData, int position) {
        label.setText("推荐家居");
        label.setBackgroundResource(R.mipmap.icon_cat_08);
        if (position == 0) {
        ...
        more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("catId", "372");
                intent.putExtra("catName", "推荐家居");
