...
public class HomeBigGoodView extends RelativeLayout {
    ...
    public HomeBigGoodView(Context context) {
        super(context);
        this.mContext = context;
        initView();
    }

    public HomeBigGoodView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initView();
    }
    ...
    private void initView() {
        LayoutInflater.from(mContext).inflate(R.layout.view_home_big_good, this, true);
