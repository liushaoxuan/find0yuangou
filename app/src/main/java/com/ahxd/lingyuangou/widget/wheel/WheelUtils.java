package com.ahxd.lingyuangou.widget.wheel;
...
public class WheelUtils {
    ...
    public static void alertTimerPicker(Context context, TimePickerView.Type type, final String format,
        ...
        pvTime.setRange(calendar.get(Calendar.YEAR) - 100, calendar.get(Calendar.YEAR) + 100);
...
//                        tvTime.setText(getTime(date));
     ...
     * @param click
     */
    public static void alertBottomWheel(Context context, ArrayList<?> list, final OnWheelViewClick click) {

        final PopupWindow popupWindow = new PopupWindow();
        View view = LayoutInflater.from(context).inflate(R.layout.layout_bottom_wheel, null);
