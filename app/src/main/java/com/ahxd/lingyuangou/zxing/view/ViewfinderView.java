...
package com.ahxd.lingyuangou.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        labelTextSize = array.getFloat(R.styleable.ViewfinderView_label_text_size, 30f);
