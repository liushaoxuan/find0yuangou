package com.ahxd.lingyuangou.zxing.activity;
...
import com.ahxd.lingyuangou.zxing.camera.CameraManager;
import com.ahxd.lingyuangou.zxing.decoding.CaptureActivityHandler;
import com.ahxd.lingyuangou.zxing.decoding.InactivityTimer;
import com.ahxd.lingyuangou.zxing.decoding.RGBLuminanceSource;
import com.ahxd.lingyuangou.zxing.view.ViewfinderView;
 ...
 * @author Ryan.Tang
 */
public class CaptureActivity extends BaseActivity implements Callback, EasyPermissions.PermissionCallbacks {
...
//            Logger.d("saomiao",resultString);
    ...
    @AfterPermissionGranted(CODE_REQUESET_CANMER_PERM)
    private void initCamera(SurfaceHolder surfaceHolder) {
        if (EasyPermissions.hasPermissions(this, params)) {
            ...
            EasyPermissions.requestPermissions(this, "需要相关权限", CODE_REQUESET_CANMER_PERM, params);
        }
    }
    ...
    public static final int CODE_REQUESET_CANMER_PERM = 100;
